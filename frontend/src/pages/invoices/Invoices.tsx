...
import { ArrowUpRightIcon, FolderOpen, FileText, Download, ExternalLink, Calendar } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {blobs.length !== 0 &&
            ...
            blobs.map((blob) => (
              <Card
                key={blob.pathname}
                className="rounded-xl border border-border/40 bg-gray-300/60 shadow-sm hover:shadow-md transition-shadow"
              >
